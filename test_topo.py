...
# from p4utils.mininetlib.node import P4Switch, P4Host
...
def main():
    ...
    # net = Mininet(host = P4Host, link=TCLink, controller = None)
    net = NetworkAPI()

    # switch1 = net.addP4Switch('s1', sw_path = args.behavioral_exe, json_path = args.json, thrift_port = args.thrift_port, cls = P4Switch, pcap_dump = args.pcap_dump)
    switch1 = net.addP4Switch('s1', cli_input='cmd.txt')
    ...
    os.system('sudo simple_switch_CLI --thrift-port=9090 < cmd.txt')
